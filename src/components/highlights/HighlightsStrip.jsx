  ...
  return (
    <section className="space-y-6" aria-labelledby="highlights-title">
      <div className="flex items-center justify-between gap-4">
        <h2 id="highlights-title" className="text-sm uppercase tracking-[0.4em] text-support-teal">
          Snapshot
        </h2>
        <div className="h-px flex-1 bg-gradient-to-r from-base-700 via-base-800 to-transparent" aria-hidden />
      </div>
      <div className="grid gap-4 md:grid-cols-3">
        {items.map((item) => (
          ...
          >
            <span className="text-xs font-semibold uppercase tracking-[0.4em] text-base-400">{item.eyebrow}</span>
